...
db.Personas.insertMany([
    ...
    },
    {
        ...
        "genero": "Hombre", 
        "edad": 35, 
        "lugar_id": db.Lugares.findOne({ "nombre": "Medellín" })._id,
        "cuentas": [{ 
...
db.Productos.insertMany([
    {
        "_id": ObjectId(), "precio": 39.99, 
        "imagenProducto": "imagen1.jpg", 
        "tipoProducto": "Articulo",
        "descripcion": "Camiseta de algodón", "CategoriaArticulo": "Camiseta", 
    ...
    {
        "_id": ObjectId(), "precio": 59.99, 
        "imagenProducto": "imagen2.jpg", 
        "tipoProducto": "Articulo",
        "descripcion": "Pantaloneta deportiva", 
        "CategoriaArticulo": "Pantaloneta", 
        "seccionArticulo": "Hombre",
        "cantidadArticulo": 80, 
        "especificacionesArticulo": [
            { "cantidad": 40, "talla": "M" }, 
...
db.Envios.insertMany([
    {
        ...
        "fechaEnvio": new Date(),
        "codigoPostal": 12345, 
        "compra_id": db.Compras.findOne({ "cuenta_usuario": "juanperez" })._id,
        "lugar_id": db.Lugares.findOne({ "nombre": "Santiago de Cali" })._id
    },
    {
