...
db.Compras.insertMany([
    { "_id": ObjectId(), "cuenta_usuario": "juanperez",      "costoTotal": 179.98, "fechaCompra": new Date("2024-05-17"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Camiseta de algodón" })._id,   "cantidad": 2, "talla": "M",     "personalizacion": {} }, { "producto_id": db.Productos.findOne({ "descripcion": "Polo deportiva" })._id,   "cantidad": 2, "talla": "M",     "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "analopez",       "costoTotal": 259.99, "fechaCompra": new Date("2024-05-13"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Pantaloneta deportiva" })._id, "cantidad": 1, "talla": "M",     "personalizacion": {} }, { "producto_id": db.Productos.findOne({ "descripcion": "Gorra de béisbol" })._id, "cantidad": 1, "talla": "Única", "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "carlosgarcia",   "costoTotal": 99.99,  "fechaCompra": new Date("2024-05-13"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Gorra de béisbol" })._id,      "cantidad": 1, "talla": "Única", "personalizacion": {} }, { "producto_id": db.Productos.findOne({ "descripcion": "Polo deportiva" })._id,   "cantidad": 2, "talla": "M",     "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "luisamartinez",  "costoTotal": 159.98, "fechaCompra": new Date("2024-05-11"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Zapatillas deportivas" })._id, "cantidad": 2, "talla": "42",    "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "pedrorodriguez", "costoTotal": 29.99,  "fechaCompra": new Date("2024-05-13"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Calcetines de algodón" })._id, "cantidad": 1, "talla": "M",     "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "martadiaz",      "costoTotal": 139.98, "fechaCompra": new Date("2024-05-13"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Polo deportiva" })._id,        "cantidad": 2, "talla": "M",     "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "jorgejimenez",   "costoTotal": 99.99,  "fechaCompra": new Date("2024-05-13"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Gorra deportiva" })._id,       "cantidad": 1, "talla": "Única", "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "elenatorres",    "costoTotal": 39.99,  "fechaCompra": new Date("2024-05-17"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Zapatillas de yoga" })._id,    "cantidad": 1, "talla": "Única", "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "miguelrojas",    "costoTotal": 179.98, "fechaCompra": new Date("2024-05-11"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Pantaloneta de yoga" })._id,   "cantidad": 2, "talla": "S",     "personalizacion": {} }] },
    { "_id": ObjectId(), "cuenta_usuario": "lauramendoza",   "costoTotal": 79.98,  "fechaCompra": new Date("2024-05-17"), "detallesCompra": [{ "producto_id": db.Productos.findOne({ "descripcion": "Camiseta con capucha" })._id,  "cantidad": 2, "talla": "L",     "personalizacion": {} }] }
]);
...
db.Envios.insertMany([
    { "_id": ObjectId(), "direccion": "Calle Principal 123",    "fechaEnvio": new Date("2024-05-09"), "codigoPostal": 12345, "compra_id": db.Compras.findOne({ "cuenta_usuario": "juanperez" })._id,      "lugar_id": db.Lugares.findOne({ "nombre": "Santiago de Cali" })._id },
    { "_id": ObjectId(), "direccion": "Avenida Secundaria 456", "fechaEnvio": new Date("2024-05-10"), "codigoPostal": 67890, "compra_id": db.Compras.findOne({ "cuenta_usuario": "analopez" })._id,       "lugar_id": db.Lugares.findOne({ "nombre": "Bogotá" })._id },
    { "_id": ObjectId(), "direccion": "Carrera 10 #45-23",      "fechaEnvio": new Date("2024-05-11"), "codigoPostal": 11223, "compra_id": db.Compras.findOne({ "cuenta_usuario": "carlosgarcia" })._id,   "lugar_id": db.Lugares.findOne({ "nombre": "Medellín" })._id },
    { "_id": ObjectId(), "direccion": "Calle 50 #20-10",        "fechaEnvio": new Date("2024-05-12"), "codigoPostal": 44556, "compra_id": db.Compras.findOne({ "cuenta_usuario": "luisamartinez" })._id,  "lugar_id": db.Lugares.findOne({ "nombre": "Barranquilla" })._id },
    ...
    { "_id": ObjectId(), "direccion": "Carrera 15 #25-30",      "fechaEnvio": new Date("2024-05-14"), "codigoPostal": 66778, "compra_id": db.Compras.findOne({ "cuenta_usuario": "martadiaz" })._id,      "lugar_id": db.Lugares.findOne({ "nombre": "Bucaramanga" })._id },
    { "_id": ObjectId(), "direccion": "Avenida 5 #6-12",        "fechaEnvio": new Date("2024-05-15"), "codigoPostal": 99887, "compra_id": db.Compras.findOne({ "cuenta_usuario": "jorgejimenez" })._id,   "lugar_id": db.Lugares.findOne({ "nombre": "Pereira" })._id },
    { "_id": ObjectId(), "direccion": "Calle 70 #80-90",        "fechaEnvio": new Date("2024-05-16"), "codigoPostal": 55443, "compra_id": db.Compras.findOne({ "cuenta_usuario": "elenatorres" })._id,    "lugar_id": db.Lugares.findOne({ "nombre": "Manizales" })._id },
    { "_id": ObjectId(), "direccion": "Carrera 25 #35-40",      "fechaEnvio": new Date("2024-05-17"), "codigoPostal": 66789, "compra_id": db.Compras.findOne({ "cuenta_usuario": "miguelrojas" })._id,    "lugar_id": db.Lugares.findOne({ "nombre": "Santiago de Cali" })._id },
    { "_id": ObjectId(), "direccion": "Avenida 8 #12-15",       "fechaEnvio": new Date("2024-05-18"), "codigoPostal": 22334, "compra_id": db.Compras.findOne({ "cuenta_usuario": "lauramendoza" })._id,   "lugar_id": db.Lugares.findOne({ "nombre": "Santa Marta" })._id },
    { "_id": ObjectId(), "direccion": "Calle 30 #10-5",         "fechaEnvio": new Date("2024-05-13"), "codigoPostal": 33445, "compra_id": db.Compras.findOne({ "cuenta_usuario": "pedrorodriguez" })._id, "lugar_id": db.Lugares.findOne({ "nombre": "Cartagena" })._id },
    { "_id": ObjectId(), "direccion": "Carrera 15 #25-30",      "fechaEnvio": new Date("2024-05-14"), "codigoPostal": 66778, "compra_id": db.Compras.findOne({ "cuenta_usuario": "martadiaz" })._id,      "lugar_id": db.Lugares.findOne({ "nombre": "Bogotá" })._id },
    { "_id": ObjectId(), "direccion": "Avenida 5 #6-12",        "fechaEnvio": new Date("2024-05-15"), "codigoPostal": 99887, "compra_id": db.Compras.findOne({ "cuenta_usuario": "jorgejimenez" })._id,   "lugar_id": db.Lugares.findOne({ "nombre": "Medellín" })._id },
    { "_id": ObjectId(), "direccion": "Calle 70 #80-90",        "fechaEnvio": new Date("2024-05-16"), "codigoPostal": 55443, "compra_id": db.Compras.findOne({ "cuenta_usuario": "elenatorres" })._id,    "lugar_id": db.Lugares.findOne({ "nombre": "Santiago de Cali" })._id },
    { "_id": ObjectId(), "direccion": "Carrera 25 #35-40",      "fechaEnvio": new Date("2024-05-17"), "codigoPostal": 66789, "compra_id": db.Compras.findOne({ "cuenta_usuario": "miguelrojas" })._id,    "lugar_id": db.Lugares.findOne({ "nombre": "Santiago de Cali" })._id },
    { "_id": ObjectId(), "direccion": "Avenida 8 #12-15",       "fechaEnvio": new Date("2024-05-18"), "codigoPostal": 22334, "compra_id": db.Compras.findOne({ "cuenta_usuario": "lauramendoza" })._id,   "lugar_id": db.Lugares.findOne({ "nombre": "Bogotá" })._id }
]);
